...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["product-details-product-details-module"], {
  ...
  function srcAppProductDetailsProductDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductDetailsPage = /*#__PURE__*/function () {
      function ProductDetailsPage(domSanitizer) {
      ...
      _createClass(ProductDetailsPage, [{
        ...
        key: "toggleSelectedSize",
        value: function toggleSelectedSize(index) {
          if (this.productSizes[index].disabled) {
            return;
          }

          this.productSizes.forEach(function (item, i) {
            if (i === index) {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"]])], ProductDetailsPage);
    /***/
  }
}]);
